...
if (isset($_POST['add_image'])) {
    ...
    if (!in_array($_FILES['image']['type'], $allowedTypes) || $_FILES['image']['size'] > 2000000) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            ...
            $stmt = $conne->prepare("INSERT INTO gallery (image, type_id) VALUES (?, ?)");
            $stmt->bind_param("si", $image, $type_id);
...
// Requête SQL pour sélectionner toutes les images
$sql = "SELECT * FROM gallery WHERE type_id = 3";
                        ...
                        while($row = $result->fetch_assoc()) {
                            echo "<div class='col-md-4'>
                                    <div class='card mb-4'>
                                        ...
                                        <div class='card-body'>
                                            <form action='gallery_football_F.php' method='post' style='display: inline;'>
