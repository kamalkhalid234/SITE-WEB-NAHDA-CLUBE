                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="pages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="#" class="sidebar-link">الملف القانوني للجمعية</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="#" class="sidebar-link">الجموع العامة</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="#" class="sidebar-link">الجموع الاستثنائية
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="#" class="sidebar-link"> لائحة الأعضاء</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
